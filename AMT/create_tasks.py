...
f = csv.reader(open('June20Hotels.csv','r'), delimiter=',')
header = False 
for line in f:
  if header:
    header = False
  ...
  hotel = line[0]
  print hotel
  question = str(open(name='joinableFilterHard.xml',mode='r').read())
  question = question.replace('XXX(ITEM_NAME_HERE)XXX', hotel)
  new_hit = mturk.create_hit(
      Title = 'Evaluate a characteristic of hotel',
      Description = 'Answer a yes/no question about a hotel',
