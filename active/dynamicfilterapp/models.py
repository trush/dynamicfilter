...
class IP_Pair(models.Model):
	...
	join_process = models.CharField(max_length=200)
	...
	def distribute_task(self):
		...
		if predicate.joinable:
			...
			if not join_process:
				join = Join.objects.create(pred=p)
				self.set_join_process(join.main_join(i))
...
class Task(models.Model):
	...
	joinable = ip_pair.predicate.joinable #predicate is joinable?
