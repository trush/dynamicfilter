...
MULTI_SIM = True 
MULTI_SIM_ARRAY = [(10,(0, 1),[(0, 0, 0), (1, 10, 40), (10, 150, 200), (50, 350, 450)],[(0,4),(3,15),(10,30)],[(0, (.1,.25), (.3,.25), (.5,.25), (.5,.25), (.7,.25), (.9,.25))],1,0),
(10,(0, 1),[(0, 0, 0), (1, 10, 40), (10, 150, 200), (50, 350, 450)],[(0,4),(3,15),(10,30)],[(0, (.9,.25), (.9,.25), (.9,.25), (.9,.25), (.9,.25), (.9,.25))],1,0),
(10,(0, 1),[(0, 0, 0), (1, 10, 40), (10, 150, 200), (50, 350, 450)],[(0,4),(3,15),(10,30)],[(0, (.1,.25), (.1,.25), (.1,.25), (.1,.25), (.1,.25), (.1,.25))],1,0),
(10,(0, 1),[(0, 0, 0), (1, 10, 40)],[(0,4),(3,15),(10,30)],[(0, (.1,.25), (.3,.25), (.5,.25), (.5,.25), (.7,.25), (.9,.25))],1,1),
(10,(0, 1),[(0, 0, 0), (1, 350, 450)],[(0,4),(3,15),(10,30)],[(0, (.1,.25), (.3,.25), (.5,.25), (.5,.25), (.7,.25), (.9,.25))],1,1),
(10,(0, 1),[(0, 0, 0), (1, 10, 450)],[(0,4),(3,15),(10,30)],[(0, (.1,.25), (.3,.25), (.5,.25), (.5,.25), (.7,.25), (.9,.25))],1,1),
(10,(0, 1),[(0, 0, 0), (1, 150, 200)],[(0,4),(3,15),(10,30)],[(0, (.1,.25), (.3,.25), (.5,.25), (.5,.25), (.7,.25), (.9,.25))],1,1)]
# ************************************************************************ #
