...
# 3.5 = item-wise join on second list (all sec preds then find pairs) without second list
# 3.6 = item-wise join on second list (all find pairs then sec preds) without second list
# 3.7 = item-wise join on second list (item-by-item, sec preds first) without second list
JOIN_TYPE = 3.7
